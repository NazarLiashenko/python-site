...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///starset.db'
...
app.secret_key = 'The only thing I know for real There will be blood-shed The man in the mirror nods his head The only one left Will ride upon the dragon’s back'
